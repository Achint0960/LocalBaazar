        ...
        <div class="container">
                ...
                <nav>
                    ...
                    <div class="menu"> 
                        <ul>
                            ...
                            <li><a href="About_Us"><span></span><span></span><span></span><span></span>AboutUs</a></li>
                            <li><a href="Contac_Us"><span></span><span></span><span></span><span></span>ContactUs</a></li>
            ...
            <div class="middle" >
                <section>
                    ...
                    <div class="rightside"> 
                        <br><br>
                        <form action="LoginCodeSeller.jsp">
                        <table align="center" border="0" cellspacing="20px"  cellpadding="20px"  style="border:inset;border-color: white;">
                            ...
                            <tr align="center" style="font-weight: bold;color:white;font-size: larger">
                                <td colspan="2">SELLER SIGN IN</td>
                            </tr>

                            <tr>
                                <td style="font-weight: bold;color: white">USER ID</td>
                                <td><input name="uId" type="text" placeholder="enter id here" style="width:250px;height: 40px;background-color:white;font-size: 20px"></td>
                            </tr>

                            <tr>
                                <td style="font-weight: bold;color: white">PASSWORD</td>
                                <td><input name="pass" type="password" placeholder="enter password here" style="width:250px;height: 40px;background-color:white;font-size: 20px"></td>
                            </tr>
...
<!--                            <tr align="right">
                            ...
                            <tr align="center" >
                                <td class="theme" colspan="2">
                                    <input type="submit" value="Login"  style="font-size: 12px;font-weight: 600;color: white;text-transform: uppercase;background: linear-gradient(57deg, #00C6A7 , #1E4D92 ); border-radius: 4px 4px 4px 4px;padding: 10px 25px ;">
                                </td>
                            </tr>
