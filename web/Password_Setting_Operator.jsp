        ...
        <div class="container">
            ...
            <div class="middle" >
                <section>
                    ...
                    <div class="rightside"> 
                        <form action="operatorPasswordReset.jsp">
                        <table align="center" border="0" cellspacing="20px"  cellpadding="35px"  style="border:inset;border-color: white">
                            ...
                            <tr align="center" style="font-weight: bold;color:white;font-size: larger">
                                <td colspan="2"  class="look">OPERATOR PASSWORD RESET</td>
                            </tr>
                                
                            <tr>
                                <td class="look">OLD PASSWORD</td>
                            ...
                            <tr>
                                <td class="look">NEW PASSWORD</td>
                                <td><input name="Npassword" type="password" placeholder="Password" style="width:300px;height: 40px;background-color:white;border-radius: 10px;font-size: 20px"></td>
                            </tr>
                            
                            <tr>
                                <td class="look">CONFIRM NEW PASSWORD</td>
                                <td><input name="CNpassword" type="password" placeholder="Password" style="width:300px;height: 40px;background-color:white;border-radius: 10px;font-size: 20px"></td>
                            </tr>

                            <tr align="center">
                                <td colspan="2">
                                    <button style="margin:10px;">Reset Password</button>
                                </td>
                            </tr>
