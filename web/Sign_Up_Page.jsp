                    ...
                    <div class="rightside"> 
                        ...
                        <table align="center" border="0" cellspacing="20px"  cellpadding="35px"  style="border:inset;border-color: white">
                            ...
                            <tr>
                                ...
                                <td><input name="DOB" type="date" placeholder="Email" style="width:300px;height: 40px;background-color:white;border-radius: 10px;font-size: 20px"></td>
                            </tr>

                            <tr>
                                <td class="look">QUESTION</td>
                                <td colspan="2">
                                    <select name="log" style="width:300px;height: 40px;border-radius: 10px;background-color:white;font-size: 20px">
