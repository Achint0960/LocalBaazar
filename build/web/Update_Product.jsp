                    ...
                    <div class="rightside"> 
                        ...
                        <table align="center" border="0" cellspacing="20px"  cellpadding="35px"  style="border:inset;border-color: white">
                            ...
                            <tr align="center" style="font-weight: bold;color:white;font-size: larger">
                                <td colspan="2"  class="look">UPDATE PRODUCT</td>
                            </tr>

                            <tr>
                                <td class="look">SELECT OPTION</td>
                            ...
                            <tr>
                                <td class="look">ENTER PRODUCT ID</td>
                                <td><textarea name="Pid" placeholder="Offer" style="width:300px;height: 50px;background-color:white;border-radius: 10px;font-size: 20px"></textarea></td>
                            </tr>
