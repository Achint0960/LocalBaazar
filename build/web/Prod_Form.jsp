                    ...
                    <div class="rightside"> 
                        ...
                        <table align="center" border="0" cellspacing="20px"  cellpadding="35px"  style="border:inset;border-color: white">
                            ...
                            <tr align="center" style="font-weight: bold;color:white;font-size: larger">
                                <td colspan="2"  class="look">PAYMENT AND ADDRESS DETAILS</td>
                            </tr>
                                
                            <tr>
                                <td class="look">QUANTITY</td>
                                <td><input name="qty" type="text" placeholder="Quantity" style="width:300px;height: 40px;background-color:white;border-radius: 10px;font-size: 20px"></td>
                            </tr>
                            ...
                            <tr>
                                <td class="look">PAYMENT MODE</td>
                                <td colspan="2"><select name="payment" style="width:300px;height: 40px;border-radius: 10px;background-color:white;font-size: 20px">
