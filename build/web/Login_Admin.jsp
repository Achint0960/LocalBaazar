                ...
                <nav>
                    ...
                    <div class="menu"> 
                        <ul>
                            ...
                            <li><a href="Contact_Usa.jsp"><span></span><span></span><span></span><span></span>ContactUs</a></li>
...
<nav>
                    <div class="menu1">
                        <ul>
                            <li>Task
                                <div class="sub_menu">
                                    <ul>
                                        <li><a href="Sign_Up_Page_Operator.jsp">Create Operator Account</a></li>
                                        <li><a href="Sign_Up_Page_Seller.jsp">Create Seller Account</a></li>
                                        <li><a href="#">Delete Operator Account</a></li>
                                        <li><a href="#">Delete Seller Account</a></li>
                    ...
                    <div class="more">
                        <ul><li>More
                                <div class="sub_menu">
                                    <ul>
                                        <li><a href="Password_Setting_Admin.jsp">Settings</a></li>
