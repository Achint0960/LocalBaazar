        ...
        <div class="container">
            ...
            <div class="middle" >
                <section>
                    ...
                    <div class="rightside"> 
                        <br><br>
                        <form action="LoginCodeAdmin.jsp">
                        <table align="center" border="0" cellspacing="20px"  cellpadding="20px"  style="border:inset;border-color: white;">
                            ...
                            <tr align="center" style="font-weight: bold;color:white;font-size: larger">
                                <td colspan="2">ADMIN/OPERATOR SIGN IN</td>
                            </tr>
                            ...
                            <tr align="right">
                                <td colspan="2"><select name="login" style="width:250px;height: 40px;background-color:white;font-size: 20px">
