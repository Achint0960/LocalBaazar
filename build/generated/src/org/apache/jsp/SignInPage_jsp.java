...
public final class SignInPage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write(".leftside { width: 80%; height: auto; overflow: hidden; margin-top: 20px;}\n");
      out.write("\n");
      out.write(".leftside img{  width: 600px;  height: 500px; }\n");
      out.write("\n");
      out.write(".rightside{ width: 50%; height: 300px; color: white; text-align: center; margin-top: 80px; padding: 40px;}\n");
      out.write("\n");
      ...
      out.write("   <button style=\"margin:10px;\">Sign Up</button>\n");
      out.write("   <button style=\"margin:10px;\">Sign In</button>-->\n");
      out.write("            <br><br>\n");
      out.write("            <table align=\"center\" border=\"0\" cellspacing=\"20px\"  cellpadding=\"20px\"  style=\"border:inset;border-color: white\">\n");
      out.write("                \n");
      out.write("                <tr align=\"center\" style=\"font-weight: bold;color:white;font-size: larger\">\n");
      out.write("                    <td colspan=\"2\">USER SIGN IN</td>\n");
      out.write("                </tr>\n");
      out.write("                \n");
      out.write("                <tr>\n");
      out.write("                    <td style=\"font-weight: bold;color: white\">USER ID</td>\n");
      out.write("                    <td><input type=\"text\" placeholder=\"enter id here\" style=\"width:250px;height: 40px;background-color:white;font-size: 20px\"></td>\n");
      out.write("                </tr>\n");
      out.write("                \n");
      out.write("                <tr>\n");
      out.write("                    <td style=\"font-weight: bold;color: white\">PASSWORD</td>\n");
      out.write("                    <td><input type=\"password\" placeholder=\"enter password here\" style=\"width:250px;height: 40px;background-color:white;font-size: 20px\"></td>\n");
      out.write("                </tr>\n");
      out.write("                \n");
      out.write("                <tr align=\"right\">\n");
      out.write("                    <td colspan=\"2\"><select  style=\"width:250px;height: 40px;background-color:white;font-size: 20px\">\n");
      ...
      out.write("                    <td class=\"theme\" colspan=\"2\"><input type=\"submit\" value=\"Login\"  style=\"font-size: 12px;font-weight: 600;color: white;text-transform: uppercase;background: linear-gradient(57deg, #00C6A7 , #1E4D92 ); border-radius: 4px 4px 4px 4px;padding: 10px 25px ;\"></td>\n");
      out.write("                </tr>\n");
      out.write("                \n");
      out.write("            </table>\n");
      out.write("  </div>\n");
